...
//       onStartExam(res.data.exam || res.data);
//     } catch (err) {
//       setIsGenerating(false);
...
export default function ExamGenerator({ onBack, onStartExam }) {
  ...
  const handleGenerateExam = async () => {
    ...
    try {
      ...
      const examObj = res.data.exam; // exam generated from backend
      onStartExam(examObj);
    } catch (err) {
      setIsGenerating(false);
      alert(err.response?.data?.message || "Failed to generate exam");
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="max-w-3xl mx-auto bg-white shadow-xl p-8 rounded-2xl border">
        ...
        {/* Select Skill */}
        <div className="mb-6">
          <label className="font-semibold">Select Skill</label>
        ...
        {selectedSkillData && (
          <div className="mb-6">
            <label className="font-semibold">Topic Category</label>
            <select
              value={selectedCategory}
              onChange={(e) => setSelectedCategory(e.target.value)}
            ...
            >
              ...
              {selectedSkillData.categories.map((c) => (
        ...
        <div className="mb-6">
          ...
          />
          <p className="text-violet-600 font-semibold">{numQuestions}</p>
        </div>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full mt-2"
          />
          <p className="text-violet-600 font-semibold">{timeLimit} min</p>
        </div>
        ...
        <button
          ...
          className="w-full bg-violet-600 hover:bg-violet-700 text-white py-3 rounded-lg font-semibold text-lg mt-4"
        >
